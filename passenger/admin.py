...
class PassengerAdmin(admin.ModelAdmin):
    ...
    def make_active(self, request, queryset):
        ...
        self.message_user(request, ngettext(
            '%d Passenger has successfully been marked as active.',
            '%d Passengers have been successfully marked as active.',
            updated,
        ) % updated, messages.SUCCESS)

    make_active.short_description = "Approve Passenger"

    def make_inactive(self, request, queryset):
        updated = queryset.update(is_archived=True)
        self.message_user(request, ngettext(
            '%d Passenger has been archived successfully.',
            '%d Passengers have been archived successfully.',
            updated,
        ) % updated, messages.INFO)

    make_inactive.short_description = "Archive Passenger"
...
class PassengerFeedbackAdmin(admin.ModelAdmin):
